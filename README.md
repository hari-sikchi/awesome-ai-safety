...
4.  [Preventing Side-effects in Gridworlds](https://www.gleech.org/grids/)
5.  [A Gym Gridworld Environment for the Treacherous Turn](https://www.alignmentforum.org/posts/cKfryXvyJ522iFuNF/a-gym-gridworld-environment-for-the-treacherous-turn)
6. [ Preferences Implicit in the State of the World](http://the%20implicit%20preference%20information%20in%20an%20initial%20state/)
7. [ Conservative Agency via Attainable Utility Preservation](https://arxiv.org/abs/1902.09725)
8. [ Penalizing side effects using stepwise relative reachability](https://arxiv.org/abs/1806.01186)
9.  [ Leave no Trace: Learning to Reset for Safe and Autonomous Reinforcement Learning](https://arxiv.org/abs/1711.06782)
10.  [Incorrigibility in the CIRL Framework](https://arxiv.org/abs/1709.06275)
11.  [The Off-Switch Game.](https://arxiv.org/abs/1611.08219)
12.  [ Corrigibility](https://intelligence.org/files/Corrigibility.pdf)
13.  [Learning the Preferences of Ignorant, Inconsistent Agents](https://www.aaai.org/ocs/index.php/AAAI/AAAI16/paper/view/12476/11601)
14.  [Cooperative inverse reinforcement learning](https://arxiv.org/abs/1606.03137)
15.  [Towards Interactive Inverse Reinforcement Learning](https://jan.leike.name/publications/Towards%20Interactive%20Inverse%20Reinforcement%20Learning%20-%20Armstrong,%20Leike%202016.pdf) [.](http://jmlr.org/proceedings/papers/v37/chung15.pdf) 
17.  [ Repeated Inverse Reinforcement Learning](https://arxiv.org/abs/1705.05427)
18.  [Should robots be obedient? ](https://arxiv.org/abs/1705.09990)
19.  [ Inverse Reward Design](http://arxiv.org/abs/1711.02827)
20.  [Learning Robust Rewards with Adversarial Inverse Reinforcement Learning](https://arxiv.org/abs/1710.11248)
21.  [Simplifying Reward Design through Divide-and-Conquer](https://arxiv.org/abs/1806.02501)
22.  [An Efficient, Generalized Bellman Update For Cooperative Inverse Reinforcement Learning](https://arxiv.org/abs/1806.03820)
23.  [Reward learning from human preferences and demonstrations in Atari](https://arxiv.org/abs/1811.06521)
24.  [Supervising strong learners by amplifying weak experts](https://arxiv.org/abs/1810.08575)
25.  [AI safety via debate](https://arxiv.org/abs/1805.00899)
26.  [Trial without Error: Towards Safe Reinforcement Learning via Human Intervention](https://arxiv.org/abs/1707.05173)
27. [ Deep reinforcement learning from human preferences](https://arxiv.org/abs/1706.03741)
...
To the extent possible under law, [Harshit Sikchi](https://www.linkedin.com/in/harshit-sikchi-1b4969102/) has waived all copyright and related or neighboring rights to this work.
